            ...
            {modalStatus === "success" && (
              <div className="flex flex-col items-center gap-4 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  We've sent a confirmation to <span className="text-violet-400 font-medium">{email}</span> — check your spam if you don't see it. We'll be in touch within 24 hours.
                </p>
            ...
            {authStep === "contact" && (
              <motion.div key="contact-title" initial={{ y: 6, opacity: 0 }} animate={{ y: 0, opacity: 1 }} exit={{ opacity: 0 }}
                ...
                <BlurFade delay={0.25 * 1}>
                  <p className="text-sm font-medium text-muted-foreground">Your email address and phone number.</p>
                </BlurFade>
              </motion.div>
            )}
            {authStep === "name" && (
                            ...
                            <div className="glass-input-wrap w-full">
                              <div className="glass-input">
                                ...
                                <div className="relative z-10 flex-shrink-0 flex items-center justify-center w-10 pl-2">
                                  <AtSign className="h-5 w-5 text-foreground/80 flex-shrink-0" />
                                </div>
