    ...
    <div ref={wrapperRef} className="relative h-screen w-full" style={{ clipPath: "polygon(0% 0, 100% 0%, 100% 100%, 0 100%)" }}>
      <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-background text-foreground cinematic-footer-wrapper">
        ...
        <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 mt-20 w-full max-w-5xl mx-auto">
          ...
          <div ref={linksRef} className="flex flex-col items-center gap-6 w-full">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <ShinyButton href="#">
                <svg className="inline-block w-5 h-5 mr-2 -mt-0.5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {["Privacy Policy", "Terms of Service", "Support"].map((label) => (
                <ShinyButton key={label} href="#" className="[--shiny-cta-highlight:#6366f1] text-sm" style={{ padding: "0.65rem 1.5rem" } as React.CSSProperties}>
                  {label}
                </ShinyButton>
              ))}
            </div>
        ...
        <div className="relative z-20 w-full pb-8 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <ShinyButton onClick={scrollToTop} className="order-3" style={{ padding: "0.65rem 1.25rem" } as React.CSSProperties}>
