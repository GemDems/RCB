...
const SendButton: React.FC<SendButtonProps> = ({ onClick, disabled }) => {
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      className="send-btn flex items-center rounded-2xl bg-blue-600 text-white text-lg font-medium px-5 py-2 pl-[0.9em] overflow-hidden transition-all duration-200 cursor-pointer active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
    >
