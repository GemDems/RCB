...
export const LiquidButton: React.FC<LiquidButtonProps> = ({
  ...
  return (
    <a
      href={href}
      className={`relative inline-block sm:w-52 w-14 h-[2.7em] mx-auto group dark:bg-black bg-white dark:border-white border-black border-2 rounded-lg ${className}`}
    ...
    >
      ...
      <span className="absolute inset-0 flex items-center justify-center px-4 gap-2 rounded-lg group-hover:text-yellow-400 text-white text-sm font-semibold tracking-wide whitespace-nowrap">
        {children}
      </span>
    </a>
  );
