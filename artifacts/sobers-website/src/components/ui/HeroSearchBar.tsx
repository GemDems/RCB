  ...
  return (
    <div className={cn("relative flex items-center justify-center", className)}>
      ...
      <div id="poda" className="relative flex items-center justify-center group">
        {/* Glow layer 1 */}
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[70px] max-w-[466px] rounded-xl blur-[3px] [clip-path:inset(0_round_0.75rem)]
        ...
        {/* Glow layer 2 */}
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[65px] max-w-[464px] rounded-xl blur-[3px] [clip-path:inset(0_round_0.75rem)]
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[63px] max-w-[459px] rounded-lg blur-[2px] [clip-path:inset(0_round_0.5rem)]
        ...
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[59px] max-w-[455px] rounded-xl blur-[0.5px] [clip-path:inset(0_round_0.75rem)]
