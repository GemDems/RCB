  ...
  return (
    <div className={cn("relative flex items-center justify-center", className)}>
      ...
      <div id="poda" className="relative flex items-center justify-center group">
        {/* Glow layer 1 — wide blue/pink outer ring */}
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[70px] max-w-[466px] rounded-xl blur-[3px]
                        before:absolute before:content-[''] before:z-[-2] before:w-[999px] before:h-[999px] before:bg-no-repeat before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:rotate-60
                        before:bg-[conic-gradient(#000,#402fb5_5%,#000_38%,#000_50%,#cf30aa_60%,#000_87%)] before:transition-[transform] before:duration-2000 before:[will-change:transform]
                        group-hover:before:rotate-[-120deg] group-focus-within:before:rotate-[420deg] group-focus-within:before:duration-[4000ms]" />
        {/* Glow layer 2 — dark purple mid ring (was layers 2–4, consolidated) */}
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[65px] max-w-[464px] rounded-xl blur-[3px]
                        before:absolute before:content-[''] before:z-[-2] before:w-[600px] before:h-[600px] before:bg-no-repeat before:top-1/2 before:left-1/2 before:-translate-x-1/2 before:-translate-y-1/2 before:rotate-[82deg]
                        before:bg-[conic-gradient(rgba(0,0,0,0),#18116a,rgba(0,0,0,0)_10%,rgba(0,0,0,0)_50%,#6e1b60,rgba(0,0,0,0)_60%)] before:transition-[transform] before:duration-2000 before:[will-change:transform]
                        group-hover:before:rotate-[-98deg] group-focus-within:before:rotate-[442deg] group-focus-within:before:duration-[4000ms]" />
        {/* Glow layer 3 — bright lavender/pink edge */}
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[63px] max-w-[459px] rounded-lg blur-[2px]
                        ...
                        before:transition-[transform] before:duration-2000 before:[will-change:transform] group-hover:before:rotate-[-97deg] group-focus-within:before:rotate-[443deg] group-focus-within:before:duration-[4000ms]" />
        {/* Glow layer 4 — dark inner border */}
        <div className="absolute z-[-1] overflow-hidden h-full w-full max-h-[59px] max-w-[455px] rounded-xl blur-[0.5px]
                        ...
                        before:transition-[transform] before:duration-2000 before:[will-change:transform] group-hover:before:rotate-[-110deg] group-focus-within:before:rotate-[430deg] group-focus-within:before:duration-[4000ms]" />
